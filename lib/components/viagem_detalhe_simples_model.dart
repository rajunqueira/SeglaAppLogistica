...
import 'viagem_detalhe_simples_widget.dart' show ViagemDetalheSimplesWidget;
import 'package:flutter/material.dart';
import 'package:flutter/scheduler.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:provider/provider.dart';

class ViagemDetalheSimplesModel
    extends FlutterFlowModel<ViagemDetalheSimplesWidget> {
  ...
  // Stores action output result for [Backend Call - SQLite (ViagemRotaViagem)] action in ViagemDetalheSimples widget.
