...
export 'viagem_model.dart';

class ViagemWidget extends StatefulWidget {
  const ViagemWidget({super.key});

  static String routeName = 'Viagem';
  static String routePath = '/viagem';
...
class _ViagemWidgetState extends State<ViagemWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ViagemModel());
  }
