...
import 'viagem_iniciar_model.dart';
export 'viagem_iniciar_model.dart';
...
class ViagemIniciarWidget extends StatefulWidget {
  ...
  @override
  State<ViagemIniciarWidget> createState() => _ViagemIniciarWidgetState();
}

class _ViagemIniciarWidgetState extends State<ViagemIniciarWidget> {
  late ViagemIniciarModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ViagemIniciarModel());
