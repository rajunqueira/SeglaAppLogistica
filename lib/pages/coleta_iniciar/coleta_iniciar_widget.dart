...
import 'coleta_iniciar_model.dart';
export 'coleta_iniciar_model.dart';
...
class ColetaIniciarWidget extends StatefulWidget {
  ...
  @override
  State<ColetaIniciarWidget> createState() => _ColetaIniciarWidgetState();
}

class _ColetaIniciarWidgetState extends State<ColetaIniciarWidget> {
  late ColetaIniciarModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ColetaIniciarModel());
