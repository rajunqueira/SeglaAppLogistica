...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFF03A9F4);
  late Color tertiary = const Color(0xFF8BC34A);
  late Color alternate = const Color(0xFFFF5722);
  late Color primaryText = const Color(0xFF212121);
  late Color secondaryText = const Color(0xFF757575);
  late Color primaryBackground = const Color(0xFFFFFFFF);
  late Color secondaryBackground = const Color(0xFFD0CFCF);
  late Color accent1 = const Color(0xFF9E9E9E);
  late Color accent2 = const Color(0xFF3F51B5);
  late Color accent3 = const Color(0xFFFFEB3B);
  late Color accent4 = const Color(0xFFE91E63);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFFFB300);
  late Color secondary = const Color(0xFF0288D1);
  late Color tertiary = const Color(0xFF689F38);
  late Color alternate = const Color(0xFFE64A19);
  ...
  late Color accent3 = const Color(0xFFFBC02D);
  late Color accent4 = const Color(0xFFD81B60);
