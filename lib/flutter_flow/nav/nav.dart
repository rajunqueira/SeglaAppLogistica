...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? NavBarPage() : AutenticacaoWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: AutenticacaoWidget.routeName,
          path: AutenticacaoWidget.routePath,
          builder: (context, params) => AutenticacaoWidget(),
        ),
        FFRoute(
          name: ViagemRotaWidget.routeName,
          path: ViagemRotaWidget.routePath,
          builder: (context, params) => ViagemRotaWidget(
            viagemStatus: params.getParam(
              'viagemStatus',
              ParamType.DataStruct,
              isList: false,
              structBuilder: ViagemListStruct.fromSerializableMap,
            ),
            viagemId: params.getParam(
              'viagemId',
              ParamType.int,
            ),
          ),
        ...
        FFRoute(
          ...
          path: PesagemIncluirWidget.routePath,
          builder: (context, params) => PesagemIncluirWidget(
