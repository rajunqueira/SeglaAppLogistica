...
class PontoColetaRotaStruct extends BaseStruct {
  PontoColetaRotaStruct({
    int? id,
    String? apelido,
    String? descricao,
    String? idCliente,
  ...
  static PontoColetaRotaStruct fromMap(Map<String, dynamic> data) =>
      PontoColetaRotaStruct(
  ...
  static PontoColetaRotaStruct? maybeFromMap(dynamic data) => data is Map
      ? PontoColetaRotaStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static PontoColetaRotaStruct fromSerializableMap(Map<String, dynamic> data) =>
      PontoColetaRotaStruct(
        id: deserializeParam(
          data['id'],
          ParamType.int,
  ...
  @override
  String toString() => 'PontoColetaRotaStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is PontoColetaRotaStruct &&
        id == other.id &&
...
PontoColetaRotaStruct createPontoColetaRotaStruct({
  int? id,
  String? apelido,
  String? descricao,
  String? idCliente,
