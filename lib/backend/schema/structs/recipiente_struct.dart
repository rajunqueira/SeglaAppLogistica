...
class RecipienteStruct extends BaseStruct {
  RecipienteStruct({
    int? id,
    String? idDominio,
  ...
  static RecipienteStruct fromMap(Map<String, dynamic> data) =>
      RecipienteStruct(
  ...
  static RecipienteStruct? maybeFromMap(dynamic data) => data is Map
      ? RecipienteStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static RecipienteStruct fromSerializableMap(Map<String, dynamic> data) =>
      RecipienteStruct(
        id: deserializeParam(
          data['id'],
          ParamType.int,
  ...
  @override
  String toString() => 'RecipienteStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is RecipienteStruct &&
        id == other.id &&
...
RecipienteStruct createRecipienteStruct({
  int? id,
  String? idDominio,
  String? idEstabelecimento,
  String? idCliente,
