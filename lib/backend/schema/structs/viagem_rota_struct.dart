...
class ViagemRotaStruct extends BaseStruct {
  ViagemRotaStruct({
    int? id,
    int? idViagem,
    int? idContratoRota,
  ...
  // "ContratoRota" field.
  String? _contratoRota;
  String get contratoRota => _contratoRota ?? '';
  set contratoRota(String? val) => _contratoRota = val;

  bool hasContratoRota() => _contratoRota != null;

  // "Viagen" field.
  String? _viagen;
  String get viagen => _viagen ?? '';
  set viagen(String? val) => _viagen = val;

  bool hasViagen() => _viagen != null;

  // "ViagemRotaStatus" field.
  String? _viagemRotaStatus;
  String get viagemRotaStatus => _viagemRotaStatus ?? '';
  set viagemRotaStatus(String? val) => _viagemRotaStatus = val;

  bool hasViagemRotaStatus() => _viagemRotaStatus != null;

  static ViagemRotaStruct fromMap(Map<String, dynamic> data) =>
      ViagemRotaStruct(
        ...
        contratoRota: data['ContratoRota'] as String?,
        viagen: data['Viagen'] as String?,
        viagemRotaStatus: data['ViagemRotaStatus'] as String?,
      );

  static ViagemRotaStruct? maybeFromMap(dynamic data) => data is Map
      ? ViagemRotaStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  Map<String, dynamic> toMap() => {
        ...
        'deletado': _deletado,
        'ContratoRota': _contratoRota,
        'Viagen': _viagen,
        'ViagemRotaStatus': _viagemRotaStatus,
      }.withoutNulls;
  ...
  static ViagemRotaStruct fromSerializableMap(Map<String, dynamic> data) =>
      ViagemRotaStruct(
        id: deserializeParam(
          data['id'],
          ParamType.int,
        ...
        contratoRota: deserializeParam(
          data['ContratoRota'],
          ParamType.String,
          false,
        ),
        viagen: deserializeParam(
          data['Viagen'],
          ParamType.String,
          false,
        ),
        viagemRotaStatus: deserializeParam(
  ...
  @override
  String toString() => 'ViagemRotaStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is ViagemRotaStruct &&
        id == other.id &&
...
ViagemRotaStruct createViagemRotaStruct({
  int? id,
  int? idViagem,
  int? idContratoRota,
  int? idViagemRotaStatus,
  ...
  String? viagemRotaStatus,
    ...
    ViagemRotaStruct(
      ...
      deletado: deletado,
      contratoRota: contratoRota,
      viagen: viagen,
      viagemRotaStatus: viagemRotaStatus,
    );
