...
class PesagemstatusListStruct extends BaseStruct {
  PesagemstatusListStruct({
    int? id,
    String? idEmpresa,
    String? apelido,
    String? descricao,
  ...
  static PesagemstatusListStruct fromMap(Map<String, dynamic> data) =>
      PesagemstatusListStruct(
  ...
  static PesagemstatusListStruct? maybeFromMap(dynamic data) => data is Map
      ? PesagemstatusListStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static PesagemstatusListStruct fromSerializableMap(
  ...
  @override
  String toString() => 'PesagemstatusListStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is PesagemstatusListStruct &&
        id == other.id &&
...
PesagemstatusListStruct createPesagemstatusListStruct({
  int? id,
  String? idEmpresa,
  String? apelido,
  String? descricao,
