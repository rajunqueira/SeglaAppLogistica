...
class TiporesiduoListStruct extends BaseStruct {
  TiporesiduoListStruct({
    int? id,
    String? idDominio,
  ...
  static TiporesiduoListStruct fromMap(Map<String, dynamic> data) =>
      TiporesiduoListStruct(
  ...
  static TiporesiduoListStruct? maybeFromMap(dynamic data) => data is Map
      ? TiporesiduoListStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static TiporesiduoListStruct fromSerializableMap(Map<String, dynamic> data) =>
      TiporesiduoListStruct(
        id: deserializeParam(
          data['id'],
          ParamType.int,
  ...
  @override
  String toString() => 'TiporesiduoListStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is TiporesiduoListStruct &&
        id == other.id &&
...
TiporesiduoListStruct createTiporesiduoListStruct({
  int? id,
  String? idDominio,
  String? idEstabelecimento,
  String? idCliente,
