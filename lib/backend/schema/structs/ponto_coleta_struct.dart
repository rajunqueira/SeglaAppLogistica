...
class PontoColetaStruct extends BaseStruct {
  PontoColetaStruct({
    int? id,
    String? apelido,
    String? descricao,
  ...
  static PontoColetaStruct fromMap(Map<String, dynamic> data) =>
      PontoColetaStruct(
  ...
  static PontoColetaStruct? maybeFromMap(dynamic data) => data is Map
      ? PontoColetaStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static PontoColetaStruct fromSerializableMap(Map<String, dynamic> data) =>
      PontoColetaStruct(
        id: deserializeParam(
          data['id'],
          ParamType.int,
  ...
  @override
  String toString() => 'PontoColetaStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is PontoColetaStruct &&
        id == other.id &&
...
PontoColetaStruct createPontoColetaStruct({
  int? id,
  String? apelido,
  String? descricao,
  bool? cancelado,
